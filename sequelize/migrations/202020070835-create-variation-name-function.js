module.exports.up = (queryInterface, DataTypes) => {
    return queryInterface.sequelize.query(`
      create function product_variation_name(product_variation_id bigint unsigned)
            ...
            begin
                ...
                select concat(b.name, ' ', p.name, ' ', coalesce(group_concat(concat(a.name, ':', if(a.type = 'image', apv.alt, apv.value))),' nothing'))
                ...
                from product_variations
                         ...
                         left join attributes a on pa.id = a.id
  ...
  module.exports.down = (queryInterface) => queryInterface.sequelize.query(" drop function product_variation_name");
